...
for i in range(len(model_names)):
    plt.plot(model_snr_all[i] / 10, model_mse_all[i], '.', color='gray', alpha=0.005) #line_colors[i]
    plt.errorbar(snr_bin_center + i * 0.05 - 0.125, mse_median_all[i], yerr=mse_error_bar_all[i],
